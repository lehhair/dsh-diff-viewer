window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$1 = ".PQvqva_root{flex-direction:column;display:flex}.PQvqva_row{position:relative;overflow:hidden}.PQvqva_root[data-state=running] .PQvqva_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite PQvqva_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes PQvqva_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.PQvqva_leading{flex-shrink:0}.PQvqva_root[data-tool^=cordis_] .PQvqva_leading,.PQvqva_root[data-tool^=cordis_] .PQvqva_title{color:var(--dsw-alias-state-business-primary)}.PQvqva_root[data-tool^=cordis_] .PQvqva_title{font-weight:500}.PQvqva_root[data-tool^=cordis_] .PQvqva_sep{background:var(--dsw-alias-state-business-primary)}.PQvqva_chevron{color:var(--dsw-alias-label-secondary)}.PQvqva_title{font-weight:400}.PQvqva_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.PQvqva_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.PQvqva_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.PQvqva_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.PQvqva_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.PQvqva_errorSummary{color:var(--dsw-alias-state-error-primary)}.PQvqva_bodyWrap{flex-direction:column;display:flex}.PQvqva_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.PQvqva_root:hover .PQvqva_inspectButton,.PQvqva_inspectButton:focus-visible{opacity:1}.PQvqva_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.PQvqva_bodyScroll{max-height:260px;overflow-y:auto}.PQvqva_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.PQvqva_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.PQvqva_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.PQvqva_ioSection::-webkit-scrollbar-track{margin:6px 0}.PQvqva_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.PQvqva_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.PQvqva_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.PQvqva_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.PQvqva_codeBody,.PQvqva_terminalBody,.PQvqva_diffBody,.PQvqva_readBody,.PQvqva_searchBody,.PQvqva_webBody{margin:4px 0 4px 4px}.PQvqva_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.PQvqva_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.PQvqva_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.PQvqva_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"row": "PQvqva_row",
			"fileLink": "PQvqva_fileLink",
			"ioDivider": "PQvqva_ioDivider",
			"codeBody": "PQvqva_codeBody",
			"bodyScroll": "PQvqva_bodyScroll",
			"ioCard": "PQvqva_ioCard",
			"ioLabel": "PQvqva_ioLabel",
			"ioSection": "PQvqva_ioSection",
			"diffBody": "PQvqva_diffBody",
			"readBody": "PQvqva_readBody",
			"searchRecovery": "PQvqva_searchRecovery",
			"ioText": "PQvqva_ioText",
			"visuallyHidden": "PQvqva_visuallyHidden",
			"summarySuffix": "PQvqva_summarySuffix",
			"leading": "PQvqva_leading",
			"summary": "PQvqva_summary",
			"root": "PQvqva_root",
			"dsh-tool-row-sweep": "PQvqva_dsh-tool-row-sweep",
			"chevron": "PQvqva_chevron",
			"errorSummary": "PQvqva_errorSummary",
			"bodyWrap": "PQvqva_bodyWrap",
			"inspectButton": "PQvqva_inspectButton",
			"searchBody": "PQvqva_searchBody",
			"webBody": "PQvqva_webBody",
			"sep": "PQvqva_sep",
			"title": "PQvqva_title",
			"terminalBody": "PQvqva_terminalBody"
		};
		//#endregion
...
XID_Start XIDS`.split(/\s/).map((p) => [w(p), p]));
		...
		*/
		...
		const css = ".n6RsMW_block{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);border-radius:12px;position:relative}.n6RsMW_copyButton{z-index:1;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xs-13);background-color:#0000;border:none;margin:0;padding:0;position:absolute;top:8px;right:12px}.n6RsMW_footer{font:var(--dsw-font-markdown-code-block);color:var(--dsw-alias-label-tertiary);padding:0 14px 12px}.n6RsMW_file+.n6RsMW_file{border-top:1px solid var(--dsw-alias-border-l2)}.n6RsMW_fileHeader{color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code-block);padding:10px 14px 4px;font-weight:600}.n6RsMW_body{font:var(--dsw-font-markdown-code-block);line-height:22px}.n6RsMW_viewport{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);overflow:hidden auto}.n6RsMW_hbar{z-index:2;background:var(--dsw-alias-markdown-code-block);height:8px;position:sticky;bottom:0;overflow:auto hidden}.n6RsMW_content,.n6RsMW_hbar{scrollbar-width:thin;scrollbar-color:transparent transparent}.n6RsMW_content:hover,.n6RsMW_content:focus-within,.n6RsMW_hbar:hover,.n6RsMW_hbar:focus-within{scrollbar-color:var(--dsh-scrollbar-thumb) transparent}.n6RsMW_content::-webkit-scrollbar-thumb,.n6RsMW_hbar::-webkit-scrollbar-thumb{background:0 0}.n6RsMW_content:hover::-webkit-scrollbar-thumb,.n6RsMW_content:focus-within::-webkit-scrollbar-thumb,.n6RsMW_hbar:hover::-webkit-scrollbar-thumb,.n6RsMW_hbar:focus-within::-webkit-scrollbar-thumb{background:var(--dsh-scrollbar-thumb)}.n6RsMW_spacer{position:relative}.n6RsMW_window{position:absolute;top:0;left:0;right:0}.n6RsMW_splitRow{display:flex}.n6RsMW_panel{flex:1 1 0;min-width:0;display:flex}.n6RsMW_panel+.n6RsMW_panel{border-left:1px solid var(--dsw-alias-border-l1)}.n6RsMW_unifiedRow{display:flex}.n6RsMW_gutter{flex-direction:column;flex-shrink:0;display:flex;overflow:visible}.n6RsMW_content{flex:1 1 0;min-width:0;overflow-x:auto}.n6RsMW_rows{width:max-content;min-width:100%;display:block}.n6RsMW_gutterRow{white-space:pre;align-items:stretch;height:22px;display:flex}.n6RsMW_contentRow{box-sizing:border-box;white-space:pre;width:100%;height:22px;padding-right:12px}.n6RsMW_lineNumber{box-sizing:border-box;text-align:right;user-select:none;flex-shrink:0;padding:0 12px 0 16px;line-height:22px}.n6RsMW_lineNumberChanged{color:var(--dsw-alias-label-secondary)}.n6RsMW_lineNumberContext{color:var(--dsw-alias-label-tertiary)}.n6RsMW_barAdd{background:var(--dsw-alias-state-success-primary);flex:none;width:4px}.n6RsMW_barDelete{background-image:linear-gradient(0deg, color-mix(in srgb, var(--dsw-alias-state-error-primary) 45%, transparent) 50%, var(--dsw-alias-state-error-primary) 50%);background-repeat:repeat;background-size:2px 2px;flex:none;width:4px}.n6RsMW_barNone{flex:none;width:4px}.n6RsMW_rowAdd{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 12%, transparent)}.n6RsMW_rowDelete{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent)}.n6RsMW_rowContext{background:0 0}.n6RsMW_rowEmpty{background-color:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 18%, transparent);background-size:8px 8px;background-origin:border-box;background-image:repeating-linear-gradient(-45deg, transparent, transparent calc(3px * 1.414), color-mix(in srgb, var(--dsw-alias-border-l2) 48%, transparent) calc(3px * 1.414), color-mix(in srgb, var(--dsw-alias-border-l2) 48%, transparent) calc(4px * 1.414))}.n6RsMW_wordAdd{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 28%, transparent)}.n6RsMW_wordDelete{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 28%, transparent)}.n6RsMW_noChanges{color:var(--dsw-alias-label-tertiary);padding:12px 14px}.n6RsMW_separatorSurface{border-block:1px solid color-mix(in srgb, var(--dsw-alias-border-l2) 50%, transparent);background-color:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 45%, transparent);min-width:0;color:var(--dsw-alias-label-tertiary);align-items:stretch;display:flex}.n6RsMW_separatorRelative{position:relative;overflow:visible}.n6RsMW_separatorButtonGroup{user-select:none;fill:currentColor;flex:none;align-items:stretch;height:100%;display:flex}.n6RsMW_separatorButton{border:0;border-right:2px solid var(--dsw-alias-markdown-code-block);width:32px;min-width:32px;height:100%;color:var(--dsw-alias-label-tertiary);cursor:pointer;box-sizing:border-box;background-color:#0000;flex:0 0 32px;justify-content:center;align-items:center;padding:0;line-height:0;display:flex}.n6RsMW_separatorButton:hover{color:var(--dsw-alias-label-primary)}.n6RsMW_expandIcon{transform-origin:50%;flex:0 0 16px;width:16px;height:16px;display:block}.n6RsMW_expandIconUp{transform:scaleY(-1)}.n6RsMW_separatorLabelOverlay{z-index:2;align-items:stretch;height:100%;display:flex;position:absolute;top:0;right:-100vw}.n6RsMW_separatorLabel{flex:auto;align-items:center;min-width:0;padding:0 1ch;display:flex;overflow:hidden}.n6RsMW_separatorTextButton{min-width:0;max-width:100%;color:var(--dsw-alias-label-tertiary);font:inherit;line-height:inherit;text-overflow:ellipsis;white-space:nowrap;cursor:pointer;background-color:#0000;border:0;padding:0;overflow:hidden}.n6RsMW_separatorTextButton:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}";
		...
		var DiffViewer_module_css_default = {
			"block": "n6RsMW_block",
			"lineNumberContext": "n6RsMW_lineNumberContext",
			"rowEmpty": "n6RsMW_rowEmpty",
			"rowAdd": "n6RsMW_rowAdd",
			"barAdd": "n6RsMW_barAdd",
			"noChanges": "n6RsMW_noChanges",
			"separatorSurface": "n6RsMW_separatorSurface",
			"file": "n6RsMW_file",
			"unifiedRow": "n6RsMW_unifiedRow",
			"rows": "n6RsMW_rows",
			"lineNumberChanged": "n6RsMW_lineNumberChanged",
			"hbar": "n6RsMW_hbar",
			"copyButton": "n6RsMW_copyButton",
			"wordAdd": "n6RsMW_wordAdd",
			"expandIcon": "n6RsMW_expandIcon",
			"fileHeader": "n6RsMW_fileHeader",
			"content": "n6RsMW_content",
			"spacer": "n6RsMW_spacer",
			"separatorButtonGroup": "n6RsMW_separatorButtonGroup",
			"expandIconUp": "n6RsMW_expandIconUp",
			"separatorLabel": "n6RsMW_separatorLabel",
			"separatorTextButton": "n6RsMW_separatorTextButton",
			"gutterRow": "n6RsMW_gutterRow",
			"separatorButton": "n6RsMW_separatorButton",
			"panel": "n6RsMW_panel",
			"contentRow": "n6RsMW_contentRow",
			"lineNumber": "n6RsMW_lineNumber",
			"wordDelete": "n6RsMW_wordDelete",
			"footer": "n6RsMW_footer",
			"barNone": "n6RsMW_barNone",
			"viewport": "n6RsMW_viewport",
			"gutter": "n6RsMW_gutter",
			"window": "n6RsMW_window",
			"separatorLabelOverlay": "n6RsMW_separatorLabelOverlay",
			"separatorRelative": "n6RsMW_separatorRelative",
			"body": "n6RsMW_body",
			"splitRow": "n6RsMW_splitRow",
			"rowContext": "n6RsMW_rowContext",
			"barDelete": "n6RsMW_barDelete",
			"rowDelete": "n6RsMW_rowDelete"
		};
